        ...
        <div style="width: 75%; max-width: 1400px; display: flex; align-items: center; gap: 50px; flex-wrap: wrap;">
            ...
            <div style="flex: 1; min-width: 300px; display: flex; flex-direction: column; justify-content: center;">
                ...
                <p style="color: #64748b; font-size: 0.95rem; line-height: 1.6; margin-bottom: 25px;" data-i18n="index_txt_18">
                    En <strong>Advance South Central</strong>, nos especializamos en la selección, inspección y exportación de vehículos JDM, comerciales y particulares directo desde las subastas niponas. Con años de experiencia en logística portuaria, aseguramos un proceso transparente, legal y seguro para que recibas tu auto sin complicaciones en tu país de origen.
                </p>
